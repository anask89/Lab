...
public class Employee extends Connect {
    ...
    public Employee() {
        ...
        //////////Save User Details /////
    public String saveEmployee(@SuppressWarnings("rawtypes") HashMap employeeData) {

        String SQL = "INSERT INTO employee (employee_sal, employee_first_name, employee_middle_name, employee_last_name, employee_gender, employee_address,employee_state, employee_country, employee_landline, employee_mobile, employee_email, employee_status, employee_deparment, employee_dob, employee_nationalty, employee_manager_id, employee_role) VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,  ?, ?, ?, ?, ?, ?, ?);";
        ...
        try {
            ...
            pstmt.setString(7, (String) employeeData.get("employee_state"));
            pstmt.setString(8, (String) employeeData.get("employee_country"));
            pstmt.setString(9, (String) employeeData.get("employee_landline"));
            pstmt.setString(10, (String) employeeData.get("employee_mobile"));
            pstmt.setString(11, (String) employeeData.get("employee_email"));
            pstmt.setString(12, (String) employeeData.get("employee_status"));
            pstmt.setString(13, (String) employeeData.get("employee_deparment"));
            pstmt.setString(14, (String) employeeData.get("employee_dob"));
            pstmt.setString(15, (String) employeeData.get("employee_nationalty"));
            pstmt.setString(16, (String) employeeData.get("employee_manager_id"));
	...
	public HashMap<String, Comparable> getEmployeeDetails(int employee_id) {
		HashMap<String, Comparable> resultsArray = new HashMap<String, Comparable>();
        int count = 0;
        try {
    ...
    public String updateEmployee(HashMap<?, ?> employeeData) {
        String SQL = "UPDATE employee SET employee_sal = ?, employee_first_name = ?, employee_middle_name = ?, employee_last_name = ?, employee_gender = ?, employee_address = ?, employee_state = ?, employee_country = ?, employee_landline = ?, employee_mobile = ?, employee_email = ?, employee_status = ?, employee_deparment = ?, employee_dob = ?, employee_nationalty = ?, employee_manager_id = ?, employee_role = ? WHERE employee_id = ?";
        String error = "";
    ...
    public ArrayList<HashMap<String, Comparable>> getAllEmployee(String managerID) {
        int count = 0;
        String error = "";
        String SQL = "SELECT * FROM employee";

        ArrayList<HashMap<String, Comparable>> resultArray = new ArrayList<HashMap<String, Comparable>>();
        try {
            ...
            rs = statement.executeQuery(SQL);
            while (rs.next()) {
                HashMap<String, Comparable> results = new HashMap<String, Comparable>();
