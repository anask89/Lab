...
public class StudentSeat extends Connect {
	...
	public HashMap<String, Comparable> getStudentSeatDetails(int ss_id) {
    ...
    public ArrayList<HashMap<String, String>> getAllStudentSeat() {
    ...
    @SuppressWarnings("rawtypes")
	public HashMap<String, Comparable> getStudentSeats(String student_id) {
        HashMap<String, Comparable> results = new HashMap<String, Comparable>();
        int count = 0;
        try {
