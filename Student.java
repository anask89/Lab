...
public class Student extends Connect {
    ...
    public String saveStudent(@SuppressWarnings("rawtypes") HashMap studentData) {
	...
	public HashMap<String, Comparable> getStudentDetails(int student_id) {
        @SuppressWarnings("rawtypes")
		HashMap<String, Comparable> results = new HashMap();
        int count = 0;
        try {
    ...
    @SuppressWarnings("rawtypes")
	public ArrayList<HashMap<String, Comparable>> getAllStudent() {
